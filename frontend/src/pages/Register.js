      ...
      <div style={styles.card}>
        ...
        <form onSubmit={handleSubmit}>
          <div style={styles.field}>
            ...
            <input style={styles.input} type="text" placeholder="Vivesh Rajput"
...
const styles = {
  ...
  btnDisabled: {
    width: '100%', padding: '15px', background: '#444', border: 'none',
    borderRadius: '12px', color: '#888', fontSize: '16px', fontWeight: '600',
